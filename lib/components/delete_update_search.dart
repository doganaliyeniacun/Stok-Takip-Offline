...
Future<dynamic> searchStock(BuildContext context) {
  StockDeleteUpdateController _stockDeleteUpdateController =
            ...
            children: [
              CustomTextFormField1(
                ...
                textEditingController:
                    _stockDeleteUpdateController.searchController,
                onChanged: (value) => _stockDeleteUpdateController
                    .searchStockList(value.toString()),
              ),
              Expanded(
                child: Obx(
                  () => ListView.builder(
                    itemCount: _stockDeleteUpdateController.items.length,
                    itemBuilder: (context, index) {
                      var list = _stockDeleteUpdateController.items[index];
                      return IntrinsicHeight(
                        child: GestureDetector(
                          onTap: () {
                            _stockDeleteUpdateController.row1.text =
